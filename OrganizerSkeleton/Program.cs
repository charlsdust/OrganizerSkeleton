...
namespace OrganizerSkeleton
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            RzeczyFactory rzeczyFactory = new RzeczyFactory();
            IRzecz new_rzecz = rzeczyFactory.GetRzecz("płyta");
            new_rzecz.Author = "wodka";
            
            Console.WriteLine(new_rzecz.Author);
            Console.WriteLine(new_rzecz.GetType());
